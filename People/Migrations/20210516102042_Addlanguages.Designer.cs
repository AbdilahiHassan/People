...
namespace People.Migrations
{
    ...
    [Migration("20210516102042_Addlanguages")]
            ...
            modelBuilder.Entity("CityPerson", b =>
                {
                    ...
                    b.Property<int>("townresidentId")
                        .HasColumnType("int");

                    b.HasKey("CityIdId", "townresidentId");

                    b.HasIndex("townresidentId");
            ...
            modelBuilder.Entity("CityPerson", b =>
                {
                    ...
                    b.HasOne("People.Models.PersonData.Person", null)
                        .WithMany()
                        .HasForeignKey("townresidentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
